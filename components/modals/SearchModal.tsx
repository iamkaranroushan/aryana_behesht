...
export default function SearchModal() {
  ...
  const results = ["Waziri Kebab ", "Sultani Kebab", "Chenjeh Kebab", "Tandoori Boneless Spicy Chicken", "Barg Kebab"].filter((r) =>
  ...
  return (
    <div
      className="
        ...
        w-[95vw] max-w-2xl rounded-xl bg-neutral-900 p-6 text-white shadow-2xl
      "
    >
      {/* Close button */}
      <button
